...
![Information processing framework illustrating the key inputs, processing mechanisms, and outputs in human-AI group decision-making.](Assets/ip3.png){width=105%}
...
- Transactive Memory and Shared Mental Models: How AI systems function as external knowledge repositories (Bienefeld et al., 2023; Narayanan & Feigh, 2024)
...
AI assistance can influence the workload and cognitive load experienced by human team members [@bastolaLLMbasedSmartReply2024; @bucincaTrustThinkCognitive2021; @choiLLMEffectAre2024; @gerlichAIToolsSociety2025]. While AI can reduce cognitive load by automating certain tasks and providing ready-made solutions (Hao et al., 2024), it can also increase cognitive load if the AI interface is poorly designed or if the AI's reasoning is opaque [@bucincaTrustThinkCognitive2021; @westphalDecisionControlExplanations2023].
...
- Cognitive Load and Overreliance: Role of interface design in prompting deeper analytic thinking (Buçinca et al., 2021; Vodrahalli et al., 2022)
